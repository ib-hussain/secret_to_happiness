...
This data package contains the data that powers the chart ["Suicide rate"](https://ourworldindata.org/grapher/death-rate-from-suicides-ghe?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on November 22, 2025.
